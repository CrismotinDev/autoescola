            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <span class="mb-4">Cobranças</span><br>
                            <div class="mt-2">
                                <?php
                                use App\Models\conta_receber;
                                $tabela = conta_receber::where('aluno', '=', $id2)->get();
                           ?>
                           ...
                           ?>
                           <small><span><i class="fas fa-check mr-1 text-success <?php if($item->pago != 'Sim'){?> text-danger <?php } ?>"></i>{{$item->descricao}} R$ {{$valor}} - {{$data}}</i></span></small><hr>
                           @endforeach
