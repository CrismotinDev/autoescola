...
<form method="POST" action="{{route('instrutores.editar', $item)}}">
    ...
    @method('put')
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input value="{{$item->data_vencimento}}" value="<?php echo date('Y-m-d') ?>" type="date" class="form-control" id="data" name="data">
                </div>
            </div>
        ...
        <button type="button" onclick="window.location='{{ route('instrutores.index') }}'" class="btn btn-warning">Voltar</button>
        </p>
    </form>
@endsection
